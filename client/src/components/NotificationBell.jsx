...
{isOpen && (
  <div className="absolute right-0 top-full mt-2 w-80 max-w-[90vw] sm:max-w-xs bg-white rounded-lg shadow-lg z-50 border border-gray-200 max-h-[70vh] overflow-y-auto">
